...
// https://github.com/rozek/svelte-drag-drop-touch/tree/main
	...
	var DragDropTouchSingleton = (function () {
		...
		DragDropTouch.prototype._shouldStartDragging = function (e) {
			...
			return (
				...
				(DragDropTouchSingleton._ISPRESSHOLDMODE &&
					delta >= DragDropTouchSingleton._PRESSHOLDTHRESHOLD)
			);
		};
		...
		DragDropTouch.prototype._getPoint = function (e, page) {
			if (e != null && e.touches != null && e.touches.length > 0) {
				...
				return {
					x: page ? Touch_1.pageX : Touch_1.clientX,
					y: page ? Touch_1.pageY : Touch_1.clientY
				};
			} else {
				var Event_1 = e;
				return {
					x: page ? Event_1.pageX : Event_1.clientX,
					y: page ? Event_1.pageY : Event_1.clientY
				};
			}
		};
